...
function hostinza_action_theme_include_custom_option_types() {
    if (is_admin()) {
        $dir = HOSTINZA_INC . '/includes';
...
add_action('fw_option_types_init', 'hostinza_action_theme_include_custom_option_types');
