    ...
    public function add_menu_page() {
        ...
        <div class="license-wrap">
            <?php if ( theme_is_valid_license() ): ?>
                <div class="license-content">
                    <h2 class="license-title">
                        <?php esc_html_e( 'Your license is activated', 'hostinza' ); ?>
                    </h2>
                    <div class="license-instruction">
                        <ul class="license-link">
                            <li><?php echo esc_html__("Install and active all the require plugin Follow the ", "hostinza");?> 
                                <a href="https://support.xpeedstudio.com/docs/hostinza/theme-documentation/" target="_blank"><?php echo esc_html__("Official Documentation", "hostinza"); ?></a>
                                <?php echo esc_html__("for installing the demo content, accessing the customizer etc. For more details follow the", "hostinza");?> 
                                <a href="https://www.youtube.com/watch?v=QhmxXrLhgFk&t=2s" target="_blank">
                                    <?php echo esc_html__("Video Documentation", "hostinza"); ?>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <form action="" method="POST">
                    <input 
                        ...
                        placeholder="<?php esc_attr_e( 'Enter your name', 'hostinza' ); ?>" required
                    >
                    <input 
                        type="hidden" 
                        id="email" 
                        ...
                        placeholder="<?php esc_attr_e( 'Enter your email', 'hostinza' ); ?>" required
                    >
                    <input 
                        type="hidden" 
                        id="license_key" 
                        class="regular-text" 
                        name="license_key" 
                        placeholder="<?php esc_attr_e( 'Enter your license key', 'hostinza' ); ?>"
                        value="<?php echo esc_attr( $license_key ); ?>"
                        required
                    >
                    <?php 
                        wp_nonce_field( 'theme_license_activation', 'theme_license_activation_nonce' );
                        submit_button( __('Deactivate License', 'hostinza'), 'delete button-primary', 'theme-deactive' ); 
                    ?>
                </form>
                
            <?php else: ?>
            <div class="license-content">
                <h2 class="license-title"><?php esc_html_e( 'License Activation', 'hostinza' ); ?></h2>
                <div class="license-instruction">
                    <ul class="license-link">
                        <li><?php echo esc_html__("Log into your Envato Market account ", "hostinza"); ?></li>
                        <li><?php echo esc_html__( "Hover the mouse over your username at the top of the screen.", "hostinza" ); ?></li>
                        <li><?php echo esc_html__("Click 'Downloads' from the drop-down menu.", "hostinza");?></li>
                        <li><?php echo esc_html__("Click 'License certificate & purchase code' (available as PDF or text file) See the ", "hostinza");?> 
                            <a href="https://youtu.be/srghr25uBgc" target="_blank"><br><?php echo esc_html__("Video Documentation", "hostinza"); ?></a>
                            <?php echo esc_html__("for details ", "hostinza");?> 
                        </li>
                    </ul>
                </div>
                <div class="license-desc">
                    ...
                    <p>
                        <?php esc_html_e( 'In order to get the regular updates, support, demo content & customizer option you must activate the theme license.', 'hostinza' ); ?>
                    </p>
                </div>
            </div>
            ...
            <form action="" method="POST">
                ...
                <?php 
                    submit_button( __('Activate License', 'hostinza') );
                ?>
            </form>
            <?php endif; ?>
        </div>
