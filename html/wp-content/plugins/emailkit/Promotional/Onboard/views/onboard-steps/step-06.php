...
<div class="emailkit-onboard-shapes">
    ...
    <img src="<?php echo esc_url(self::get_url()); ?>assets/images/shape-21.png" alt="" class="shape-21">
    <img src="<?php echo esc_url(self::get_url()); ?>assets/images/shape-22.png" alt="" class="shape-22">
</div>