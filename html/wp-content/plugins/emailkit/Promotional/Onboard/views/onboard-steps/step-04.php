...
echo esc_html__('Check Out the Easy to Understand Video Tutorials to learn the detailed use of EmailKit.', 'emailkit'); ?></strong></h1>
</div>
<div class="emailkit-onboard-tutorial">
    <div class="emailkit-onboard-tutorial--btn">
        <a class="emailkit-onboard-tutorial--link" data-video_id="zg1QIouKO_Q" href="#"><i class="xs-onboard-play"></i></a>
    </div>
