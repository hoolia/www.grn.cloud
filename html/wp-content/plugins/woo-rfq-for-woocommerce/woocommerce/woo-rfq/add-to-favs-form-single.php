...
<form  style="display: block" class="link_to_favs_page_form"
   ...
   <div>
       <div id='fav_link_<?php echo $product_id; ?>' style='display:block;float:left'><?php echo $fav_link ?></div>
       <div style="display: none !important; max-width:20px !important; float:left" id='image_<?php echo $product_id; ?>'>
           <image style="max-width:10px !important;margin-left:1.0em;margin-bottom: auto !important;margin-top: 0.5em !important;"  src="<?php echo (gpls_woo_rfq_URL) ?>/gpls_assets/img/select2-spinner.gif"></image></div>
